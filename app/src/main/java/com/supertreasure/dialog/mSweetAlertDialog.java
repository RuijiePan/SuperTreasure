...
public class mSweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public mSweetAlertDialog(Context context) {
        this(context, NORMAL_TYPE);
    }

    public mSweetAlertDialog(Context context, int alertType) {
        ...
        mModalOutAnim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                mDialogView.post(new Runnable() {
                    ...
                    public void run() {
                        if (mCloseFromCancel) {
                            mSweetAlertDialog.super.cancel();
                        } else {
                            mSweetAlertDialog.super.dismiss();
                        }
                    }
                });
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //AbViewUtil.scaleContentView((LinearLayout) getWindow().getDecorView().findViewById(R.id.loading));
    ...
    public void isShowTitleView(boolean show){
        setTitleText("");
        if(show)
    ...
    public mSweetAlertDialog setTitleText(String text) {
        mTitleText = text;
    ...
    public mSweetAlertDialog setCustomImage(Drawable drawable) {
    ...
    public mSweetAlertDialog setCustomImage(int resourceId) {
    ...
    public mSweetAlertDialog setContentText(String text) {
        mContentText = text;
    ...
    public mSweetAlertDialog showCancelButton(boolean isShow) {
        mShowCancel = isShow;
    ...
    public mSweetAlertDialog showContentText(boolean isShow) {
        mShowContent = isShow;
    ...
    public mSweetAlertDialog setCancelText(String text) {
        mCancelText = text;
    ...
    public mSweetAlertDialog setConfirmText(String text) {
        mConfirmText = text;
    ...
    public mSweetAlertDialog setCancelClickListener(OnSweetClickListener listener) {
        mCancelClickListener = listener;
        return this;
    }

    public mSweetAlertDialog setConfirmClickListener(OnSweetClickListener listener) {
    ...
    public void onClick(View v) {
        if (v.getId() == cn.pedant.SweetAlert.R.id.cancel_button) {
            if (mCancelClickListener != null) {
                mCancelClickListener.onClick(mSweetAlertDialog.this);
            } else {
                dismissWithAnimation();
            }
        } else if (v.getId() == cn.pedant.SweetAlert.R.id.confirm_button) {
            if (mConfirmClickListener != null) {
                mConfirmClickListener.onClick(mSweetAlertDialog.this);
            } else {
                dismissWithAnimation();
            }
        }

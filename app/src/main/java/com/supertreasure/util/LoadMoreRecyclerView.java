...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    public final static int TYPE_FOOTER = 2;//�ײ�--������loading_more
    public final static int TYPE_LIST = 3;//���itemչʾ��ģʽ��listģʽ
    public final static int TYPE_STAGGER = 4;//����itemչʾģʽ�����ģʽ
